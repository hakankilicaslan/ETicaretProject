...
@Data
@Builder
public class SaveAuthModel implements Serializable { //Bütün modeller serileştirilmelidir. Ayrıca paket isi dahil bu sınıfın aynısı iletilen serviste de deserilize edebilmesi için olmalıdır.
